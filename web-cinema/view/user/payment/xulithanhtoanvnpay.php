<?php
    ...
    if (isset($_SESSION["Payingticket"]) && isset( $_SESSION["totalCost"])) {
        ...
        $vnp_Amount = $_SESSION['totalCost'] * 100;
        $vnp_TxnRef = $_SESSION["Payingticket"]; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
        ...
        $vnp_ExpireDate = (new DateTime())->add(new DateInterval('PT15M'))->format("YmdHis");
        // //Billing
        ...
        //     $inputData['vnp_Bill_State'] = $extraData;
        // }
